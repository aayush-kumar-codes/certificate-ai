 ...
 * (which would violate OpenAI's strict schema validation)
 */
  ...
  return tool({
    ...
    parameters: {
      ...
      properties: {
        query: { 
          type: "string",
          description: "The search query text to find relevant information in the uploaded certificate documents"
        }
      },
      required: ["query"],
